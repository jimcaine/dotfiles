...
ICON_URL="https://images.dwncdn.net/images/t_app-icon-l/p/bdfb1a79-99d6-11e6-a44e-814c54aa3426/228990525/2057_4-75615072-logo"
...
echo -e "${GREEN}>>> Downloading Thinkorswim icon...${RESET}"
wget -O "$INSTALL_DIR/icon.png" "$ICON_URL"
